...
class Smarty extends Smarty_Internal_Data
{
    ...
    public $config_read_hidden = false; //Controls whether hidden config sections/vars are read from the common.
    // config vars
    ...
    public $default_resource_type = 'common';
    // caching type
    public $caching_type = 'common';
    // internal caches resource types
    public $cache_resource_types = array('common');
    // internal config properties
    public $properties = array();
    // config type
    public $default_config_type = 'common';
    ...
    public function __construct()
    {
        ...
        $this->debug_tpl = 'common:' . SMARTY_DIR . 'debug.tpl';
     ...
     *
     * @param string $template the resource handle of the template common or template object
     * @param mixed $cache_id caches id to be used with this template
    ...
    public function fetch($template, $cache_id = null, $compile_id = null, $parent = null, $display = false)
    {
        ...
        // obtain data for caches modified check
     ...
     *
     * @param string $ |object $template the resource handle of the template common  or template object
     * @param mixed $cache_id caches id to be used with this template
     * @param mixed $compile_id compile id to be used with this template
    ...
    /**
     * test if caches i valid
     *
     * @param string $ |object $template the resource handle of the template common or template object
     * @param mixed $cache_id caches id to be used with this template
     * @param mixed $compile_id compile id to be used with this template
     * @param object $parent next higher level of Smarty variables
     * @return boolean caches status
     */
    public function isCached($template, $cache_id = null, $compile_id = null, $parent = null)
    {
        ...
        // return caches status of template
     ...
     *
     * @param string $template the resource handle of the template common
     * @param mixed $cache_id caches id to be used with this template
     * @param mixed $compile_id compile id to be used with this template
     * @param object $parent next higher level of Smarty variables
     ...
     * @return integer number of caches files deleted
     */
    function clearAllCache($exp_time = null, $type = null)
    {
        // load caches resource and call clearAll
        return $this->loadCacheResource($type)->clearAll($exp_time);
    }

    /**
     * Empty caches for a specific template
     *
     * @param string $template_name template name
     * @param string $cache_id caches id
    ...
    {
        // load caches resource and call clear
    ...
    /**
     * Loads caches resource.
     *
     * @param string $type caches resource type
     * @return object of caches resource
     */
     ...
     * @return string |boolean filepath of loaded common or false
     */
