...
class Smarty_Internal_Compile_Extends extends Smarty_Internal_CompileBase {
    ...
    public function compile($args, $compiler)
    {
        ...
        $include_file = null;
        if (strpos($_attr['common'],'$_tmp') !== false || strpos($_attr['common'],'$_smarty_tpl') !== false || strpos($_attr['common'],'::') !== false) {
        	$this->compiler->trigger_template_error('a variable common attribute is illegal', $this->compiler->lex->taglineno);
        }
        eval('$include_file = ' . $_attr['common'] . ';');
        // create template object
        $_template = new $compiler->smarty->template_class($include_file, $this->smarty, $compiler->template);
        // save common dependency
