 ...
 *
 * Implements the common system as resource for the HTML caches
...
/**
 * This class does contain all necessary methods for the HTML caches on common system
 */
class Smarty_Internal_CacheResource_File
{
     ...
     *
     * @param object $_template current template
     * @return integer |booelan the template timestamp or false if the common does not exist
     */
    ...
    /**
     * Writes the rendered template output to caches common
     *
     * @param object $_template current template
