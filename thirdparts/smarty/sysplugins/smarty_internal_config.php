...
class Smarty_Internal_Config
{
    ...
    */
    public function buildConfigFilepath()
    {
        ...
        // no tpl common found
        throw new SmartyException("Unable to load config common \"{$this->config_resource_name}\"");
        return false;
    }

    /**
     * Read config common source
     *
     * @return string content of source common
     */
    /**
    ...
    public function buildCompiledFilepath()
    {
        ...
        // if use_sub_dirs, break common into directories
    ...
    /**
     * Returns the timpestamp of the compiled common
     *
     * @return integer the common timestamp
     */
    ...
    /**
     * Returns if the current config common must be compiled
     *
     * It does compare the timestamps of config source and the compiled config and checks the force compile configuration
     *
     * @return boolean true if the common must be compiled
     */
    ...
    /**
     * Returns the compiled config common
     *
     * It checks if the config common must be compiled or just read the compiled version
     *
     * @return string the compiled config common
     */
    ...
    */
    public function loadConfigVars($sections = null, $scope = 'local')
    {
        if ($this->data instanceof Smarty_Internal_Template) {
            $this->data->properties['file_dependency'][sha1($this->getConfigFilepath())] = array($this->getConfigFilepath(), $this->getTimestamp(), 'common');
        }
        if ($this->mustCompile()) {
            $this->compileConfigSource();
        }
